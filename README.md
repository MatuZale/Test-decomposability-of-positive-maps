Codes to [MATLAB](https://matlab.mathworks.com) using [CVX package](https://cvxr.com) (semidefinite programming) tests the decomposability of the Choi matrices associated with positive maps. 
